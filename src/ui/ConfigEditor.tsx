        ...
        <FieldSet label="Monitoring Site">
          <div className="gf-form">
            <FormField
              ...
              data-testid={selectors.components.ConfigEditor.backedUrl}
            />
          </div>
          <InlineField label="Edition" labelWidth={12}>
            <Select
              ...
              aria-label={selectors.components.ConfigEditor.edition}
            />
          </InlineField>
          <InlineField
            label="Version"
          ...
          >
            <Select
              ...
              aria-label={selectors.components.ConfigEditor.backend}
            />
          </InlineField>
        </FieldSet>
        <FieldSet label="Authentication">
          <div className="gf-form">
            <FormField
              ...
              data-testid={selectors.components.ConfigEditor.username}
            />
          </div>
          <div className="gf-form">
            <SecretFormField
              ...
              data-testid={selectors.components.ConfigEditor.secret}
            />
          </div>
        </FieldSet>
      </>
